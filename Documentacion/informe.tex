...
\IfFileExists{imagenes/flujo_ejecucion.png}{%
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{imagenes/flujo_ejecucion.png}
    \caption{Flujo de ejecuci\'on general del sistema}
\end{figure}
}{}
...
\begin{itemize}
    ...
    \item Se identificaron y aplicaron seis patrones de dise\~no: Singleton, Observer, Strategy, Facade, Command y Factory Method.
